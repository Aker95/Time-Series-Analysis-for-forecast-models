...
MdlBIC= arima(0,0,1);
[EstMdl,~,rB] = estimate(MdlBIC,ds.rbrent);
...
for i=0:146
    %estimo modelo
    [Mdl1,~,~] = estimate(MdlBIC,ds.rbrent(1+i:236+i)); 
    [rbrent_pronpuntoo,~] = forecast(Mdl1,1,'Y0',ds.rbrent(1+i:236+i),'V0',ds.res_AIC2(1+i:236+i),'E0',ds.res_AIC(1+i:236+i))
