...
historicalDates = ds.FECHA(1:236);
historicalData = ds.rbrent(1:236);
...
plot(ds.FECHA(237:end),ds.rbrent(237:end),'Color',[.7,.7,.7])
hold on
plot(ds.FECHA(237:end),ds.rbrent_1(237:end),'k','LineWidth',.7)
hold on
plot(ds.FECHA(237:end),IC95_caminata(237:end,1),'r','LineWidth',.7)
hold on
plot(ds.FECHA(237:end),IC95_caminata(237:end,2),'r','LineWidth',.7)
ylabel('%')
xlabel('Fecha')
hold off
legend('Rendimientos Petroleo', 'Pronóstico t=1', 'IC 95%','location','southwest')
